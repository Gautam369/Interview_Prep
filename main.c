...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, a_GPIO_Output_Pin|b_GPIO_output_Pin|c_GPIO_Output_Pin|d_GPIO_Output_Pin
                          |e_GPIO_Output_Pin|f_LD2_Pin|g_GPIO_Output_Pin|dp_GPIO_Output_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : a_GPIO_Output_Pin b_GPIO_output_Pin c_GPIO_Output_Pin d_GPIO_Output_Pin
                           e_GPIO_Output_Pin f_LD2_Pin g_GPIO_Output_Pin dp_GPIO_Output_Pin */
  GPIO_InitStruct.Pin = a_GPIO_Output_Pin|b_GPIO_output_Pin|c_GPIO_Output_Pin|d_GPIO_Output_Pin
                          |e_GPIO_Output_Pin|f_LD2_Pin|g_GPIO_Output_Pin|dp_GPIO_Output_Pin;
